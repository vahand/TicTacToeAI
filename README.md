# 🧠 Q-Learning Tic-Tac-Toe: Tabular Reinforcement Learning in Java
This repository contains a complete, from-scratch implementation of a Q-Learning agent that learns to master the game of Tic-Tac-Toe via self-play. Built entirely in standard Java (including a Swing-based GUI), this project demonstrates how classical tabular reinforcement learning can solve discrete state-space environments without relying on external machine learning libraries.
📋 Table of Contents
Project Purpose
...
While modern AI often relies on Deep Neural Networks (Deep Q-Learning), standard tabular Q-learning remains the most mathematically transparent way to understand how an AI learns temporal credit assignment (learning from delayed rewards). By mapping an AI's brain onto a visual Tic-Tac-Toe board, this project provides a real-time window into the machine's decision-making process.
🤖 Reinforcement Learning Fundamentals
...
Q(S
′
,a): The highest possible Q-value achievable from the next state (looking one step ahead).
Hyperparameters Explained
...
The State Space Reality: While 3
9
equals 19,683 theoretical combinations, there are exactly 5,478 legally reachable board states in a standard game. A successful training run will populate the HashMap with precisely this number of unique states.
Training Architecture (Self-Play)
...
Human Mistake Injection: During training, the opponent has a 20% chance to make a completely random, sub-optimal move. This forces the AI to explore "weird" board states and learn how to punish human errors.
📊 Interpreting the GUI & Q-Matrix
...
Bash
git clone https://github.com/YourUsername/QLearning-TicTacToe.git
...
Headless Training: The console will immediately begin simulating a certain amount of games of self-play. Thanks to Java's execution speed, this entire learning phase takes roughly 1 to 2 seconds.
Terminal Output: The terminal will output the total number of unique states mastered (verifying the training success).
GUI Launch: The Swing GUI will launch, prompting you to choose your turn order. Prepare to face an unbreakable opponent!